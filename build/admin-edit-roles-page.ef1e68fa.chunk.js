(self.webpackChunkpac_strapi=self.webpackChunkpac_strapi||[]).push([[2544],{4644:(K,L,o)=>{"use strict";o.d(L,{V:()=>R});var e=o(21141),C=o(88767);const R=(v={},O={})=>{const{id:P,...A}=v,{get:y}=(0,e.kY)();if(!P&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:S,error:W,isError:a,isLoading:Z,refetch:m}=(0,C.useQuery)(["roles",P,"permissions",A],async()=>{const{data:{data:M}}=await y(`/admin/roles/${P}/permissions`,{params:A});return M},O);return{permissions:S,error:W,isError:a,isLoading:Z,refetch:m}}},51754:(K,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(67294),C=o(21141),R=o(86896),v=o(88767);const O=(P={},A={})=>{const{id:y="",...S}=P,{get:W}=(0,C.kY)(),{locale:a}=(0,R.Z)(),Z=(0,C.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",y,S],async()=>{const{data:w}=await W(`/admin/roles/${y??""}`,{params:S});return w},A);return{roles:e.useMemo(()=>{let w=[];return y&&m?w=[m.data]:Array.isArray(m?.data)&&(w=m.data),[...w].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,y,Z]),error:M,isError:F,isLoading:g,refetch:b}}},25545:(K,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(67294),C=o(40720),R=o(90731),v=o(96987),O=o(12473),P=o(34726),A=o(16607),y=o(10574),S=o(31988),W=o(6498),a=o(38670),Z=o(457),m=o(21141),M=o(97695),F=o(66115),g=o(41054),b=o(41609),G=o.n(b),w=o(86896),oe=o(86706),ee=o(16550),E=o(88972),pe=o(4644),Q=o(36364),H=o(442),te=o(90065),Ce=o(87561);const xe=Ce.Ry().shape({name:Ce.Z_().required(m.I0.required),description:Ce.Z_().required(m.I0.required)}),ie=E.ZP.div`
