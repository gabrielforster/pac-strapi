"use strict";(self.webpackChunkpac_strapi=self.webpackChunkpac_strapi||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>lt});var e=n(67294),v=n(90731),m=n(96987),P=n(12473),H=n(34726),g=n(16607),r=n(21141),M=n(83598),w=n(18226),D=n(2382),X=n(97695),V=n(27361),l=n.n(V),f=n(18721),T=n.n(f),b=n(18446),x=n.n(b),k=n(11700),z=n.n(k),F=n(86896),J=n(16550),G=n(5923),ge=n(3547),fe=n(29299),_=n(69398),Z=n(10574),Be=n(38454),Pe=n(45697),o=n.n(Pe),K=n(27523),he=n(47558),C=n(90635),$=n(88972);const ye=$.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,Ne=(0,$.ZP)(g.x)`
  ...
  position: relative;
  left: -0.25rem;
`,ve=({children:t,icon:a,color:s,...i})=>e.createElement(Ne,{paddingBottom:4,paddingTop:4,as:"button",type:"button",...i},e.createElement(m.k,null,e.createElement(ze,{color:s,"aria-hidden":!0,background:`${s}200`},a),e.createElement(g.x,{paddingLeft:3},e.createElement(Z.Z,{variant:"pi",fontWeight:"bold",textColor:`${s}600`},t))));ve.propTypes={color:o().string.isRequired,children:o().string.isRequired,icon:o().node.isRequired};const Qe=ve,Ve=(0,$.ZP)(g.x)`
  table {
    width: 100%;
    white-space: nowrap;
  }
